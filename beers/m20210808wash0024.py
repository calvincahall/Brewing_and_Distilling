...
def m20210808wash0024(wash_file='',save_wash=False, overwrite=False):
    '''
    ...
    # Grain Bill kgs
    grain_bill_dict = {
            'rye_malt':         mu.lb2kg(11),
            'six_row_malt':     mu.lb2kg(11),
    }
...
wash = m20210808wash0024(wash_file, save_wash=False, overwrite=False)
