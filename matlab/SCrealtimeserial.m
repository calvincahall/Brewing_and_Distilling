...
SerialPort='/dev/cu.usbserial-A700HIH5'; %serial port
MaxDeviation = 300; % Maximum Allowable Change from one value to next 
TimeInterval=0.05;%time interval between each input.
loop=300;%count values
...
delete(s);
clear s;        
s = serial('/dev/cu.usbserial-A700HIH5');
fopen(s)
k=0;
    end
