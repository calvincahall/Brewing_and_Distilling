...
def m20191221wash0012(wash_file='',save_wash=False):
    '''
    ...
    # Grain Bill kgs
    grain_bill_dict = {'white_wheat_malt': mu.lb2kg(6),
                    'pilsner_malt': mu.lb2kg(6),
                    'rye_malt': mu.lb2kg(6)}
...
wash = m20191221wash0012(wash_file, save_wash=True)
